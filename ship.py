...
import re  # The platform module includes tools to see the platform’s hardware, operating system, and interpreter version information where the program is running.
...
class ShipDelegate(QtWidgets.QStyledItemDelegate):
    ...
    def createEditor(self, parent, option, index):
        if index.column() == TEU:
            ...
            return QtWidgets.QStyledItemDelegate.createEditor(self, parent, option,
                                                          index)
...
def generateFakeShips():
    for name, owner, country, teu, description in (
            ("Muenza Phiri","<b>James</b>", "<b>Zimbabwe</b>", 475635,
