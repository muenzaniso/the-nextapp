...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.please.clicked.connect(self.fuko)
    ...
    def fuko(self, MainWindow):
        print("We need to fuck each other")
        msgBox = QtGui.QMessageBox()
        msgBox.setTextFormat( QtCore.Qt.RichText )
        msgBox.setText("Ndipo Stonyeni")
        msgBox.setWindowTitle("Hey Sexy Lady")
        msgBox.question("Why")
